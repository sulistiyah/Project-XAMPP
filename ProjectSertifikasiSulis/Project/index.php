...
<html lang="en">
    ...
    <head>
        ...
        <meta name="author" content="Sulis Tiyah, PHP dan HTML">
                        ...
                        if(isset($_SESSION['sesi1002'])) {
                            ...
                            if(isset($r)) {
                                switch($r) {
                                    ...
                                    //Vaksin//
                                    case 'vaksin':
                                    include "form/UAS_1002/index_1002.php";
                                    break;

                                    case 'fvaksincreate':
                                    include "form/UAS_1002/create_1002.php";
                                    break;

                                    case 'fvaksindelete':
                                    include "form/UAS_1002/delete_1002.php";
                                    break;

                                    case 'fvaksinedit':
                                    include "form/UAS_1002/update_1002.php";
                                    break;
