                        ...
                        <div class="row justify-content-center"  style="margin-top: 15%">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4"><strong>Create Account</strong></h3></div>
                                    <div class="card-body">
                                        <form method='post'>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Erlangga Difa Yanzi <?php echo date('Y')?></div>
                            <div>
